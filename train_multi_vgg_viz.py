...
model = models.VGG512(n_classes=3)
...
#write_to = "/home/nabila/Desktop/github/alzheimers/Training Results/crossval_VGG512/fold2/Results"
#for idx, img in enumerate(zip(X,Y)):
#    img = images[idx].cpu().detach().permute(1,2,0).numpy()
#    gt_idx = int(Y[idx])
#    gt_class = classes[gt_idx]
#    pred_class = classes[top_classes[idx]]
#    pred_ps = soft_ps[idx]
